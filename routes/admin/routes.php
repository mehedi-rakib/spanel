...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
        ...
        Route::controller(CartController::class)->group(function () {
            ...
            Route::post(Cart::SCAN[URI], 'scanBarcode')->name('scan-barcode');
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get(Product::BULK_EDIT[URI], 'getBulkEditView')->name('bulk-edit');
            Route::post(Product::BULK_EDIT_EXPORT[URI], 'exportBulkEditData')->name('bulk-edit-export');
    ...
    Route::group(['prefix' => 'stock-history', 'as' => 'stock-history.', 'middleware' => ['module:product_management']], function () {
        Route::controller(StockHistoryController::class)->group(function () {
            Route::get(StockHistory::LIST[URI], 'index')->name('list');
        });
    });
    ...
    Route::group(['prefix' => 'custom-role', 'as' => 'custom-role.', 'middleware' => ['module:employee_management']], function () {
