                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/products/'.Product::LIST[URI].'/in-house') || Request::is('admin/products/'.Product::BULK_IMPORT[URI]) || Request::is('admin/products/'.Product::REQUEST_RESTOCK_LIST[URI])  || (Request::is('admin/products/'.Product::ADD[URI])) || (Request::is('admin/products/'.Product::VIEW[URI].'/in-house/*')) || (Request::is('admin/products/'.Product::BARCODE_GENERATE[URI].'/*'))|| (Request::is('admin/products/'.Product::UPDATE[URI].'/*') && request()->has('product-gallery')))?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/products/'.Product::BULK_EDIT[URI])?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.products.bulk-edit')}}"
                                           title="{{translate('bulk_edit')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li class="nav-item {{Request::is('admin/products/supplier*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.products.supplier.list')}}"
                                    ...
                                    <li class="nav-item {{Request::is('admin/stock-history*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.stock-history.list')}}"
                                           title="{{translate('stock_History')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('stock_History')}}</span>
                                        </a>
                                    </li>
                            ...
                            <li style="display:none;" class="navbar-vertical-aside-has-menu {{Request::is('admin/products/'.Product::LIST[URI].'/vendor*')||(Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/vendor/*'))||Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:"
                        ...
                        @if(Helpers::module_permission_check('user_section'))
                            ...
                            @if(Helpers::module_permission_check('employee_management'))
