                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    ...
                                    <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                          title="{{ translate('stock_is_now_managed_from_Purchase_and_Stock_History,_not_from_this_form') }}.">
                                        <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg') }}" alt="">
                                    </span>
                                </div>
                                <input type="number" min="0" value={{ $product->current_stock }} step="1"
                                       placeholder="{{ translate('quantity') }}"
                                       id="current_stock" class="form-control" disabled readonly>
                                <input type="hidden" name="current_stock" value="{{ $product->current_stock }}">
                                <small class="text-muted d-block mt-1">
                                    {{ translate('use_the_Purchase_or_Stock_History_page_to_change_stock') }}
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 col-xl-3">
