            ...
            <div class="card-body">
                <form id="submit-create-role" action="{{route('admin.custom-role.update',[$role['id']])}}" method="post" class="text-start">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="form-group form-check">
                                <input type="checkbox" name="modules[]" value="employee_management"
                                       class="form-check-input module-permission"
                                       id="employee_management" {{in_array('employee_management',(array)json_decode($role['module_access']))?'checked':''}}>
                                <label class="form-check-label"
                                       style="{{$direction === "rtl" ? 'margin-right: 1.25rem;' : ''}};"
                                       for="employee_management">{{translate('employee_management')}}</label>
                            </div>
                        </div>
                    </div>
