...
return [
	...
	"Total_In-House_Products" => "Total Products",
	...
	"in-House" => "In-House",
	"in-House_Earning" => "Earning",
	"in-House_Products" => "Products",
	"in-House_Shop" => "In-House Shop",
	"in-Stock" => "In-Stock",
	"in-house" => "In-house",
	"in-house_Products" => "Products",
	"in-house_Shop" => "Shop",
	"in-house_earning" => "earning",
	"in-house_product_List" => "product List",
	"in_House" => "In House",
	...
	"Message_Updated" => "Message Updated",
	"enter_your_mail_address" => "Enter your mail address",
	"Mail_Address" => "Mail Address",
	"we_will_send_you_a_temporary_OTP_in_your_mail" => "We will send you a temporary OTP in your mail",
	"use_your_registered_mail." => "Use your registered mail.",
	...
	"chattings" => "Chattings",
	"want_to_turn_Off_bkash_as_the_Digital_Payment_method" => "Want to turn Off bkash as the Digital Payment method",
	...
	"Please fill unit fields" => "Please fill unit fields",
	"Please fill minimum_order_qty fields" => "Please fill minimum order qty fields",
	"Please fill tax fields" => "Please fill tax fields",
	"Please fill discount_type fields" => "Please fill discount type fields",
	"In Side Dhaka" => "In Side Dhaka",
	"street_1,_street_2,_street_3,_street_4" => "Street 1  street 2  street 3  street 4",
	...
	"thumbnail" => "Thumbnail",
	"__MACOSX" => "  MACOSX",
	"accessories_images" => "Accessories images",
	"edit_Role" => "Edit Role",
	"role_update" => "Role update",
	"help_&_support_Section" => "Help & support Section",
	...
	"the_code_column_is_the_product_SKU_and_is_required_for_every_row." => "The code column is the product SKU and is required for every row.",
	"bulk_edit" => "Bulk edit",
	"product_Bulk_Edit" => "Product Bulk Edit",
	"bulk_Edit" => "Bulk Edit",
	"select_the_fields_you_want_to_bulk_edit_and_download_the_sheet." => "Select the fields you want to bulk edit and download the sheet.",
	"the_sheet_will_contain_every_product_with_its_id,_SKU_and_name_for_reference,_plus_the_fields_you_selected." => "The sheet will contain every product with its id  SKU and name for reference  plus the fields you selected.",
	"edit_the_values_in_the_downloaded_sheet." => "Edit the values in the downloaded sheet.",
	"do_not_change_the_id_column_or_add/remove_columns." => "Do not change the id column or add/remove columns.",
	"leave_a_cell_empty_to_keep_that_products_current_value_unchanged." => "Leave a cell empty to keep that products current value unchanged.",
	"upload_the_edited_sheet_below_to_apply_the_changes." => "Upload the edited sheet below to apply the changes.",
	"choose_fields_to_edit" => "Choose fields to edit",
	"category_id" => "Category id",
	"sub_category_id" => "Sub category id",
	"sub_sub_category_id" => "Sub sub category id",
	"brand_id" => "Brand id",
	"download_sheet" => "Download sheet",
	"upload_the_edited_sheet" => "Upload the edited sheet",
	"select_the_fields_you_want_to_bulk_edit." => "Select the fields you want to bulk edit.",
	"description,_meta_title_and_meta_description_have_a_separate_column_for_each_language." => "Description  meta title and meta description have a separate column for each language.",
	"optionally_narrow_down_which_products_to_include_using_the_filters_below,_then_download_the_sheet." => "Optionally narrow down which products to include using the filters below  then download the sheet.",
	"the_sheet_will_contain_every_matching_product_with_its_id,_SKU_and_name_for_reference,_plus_the_fields_you_selected." => "The sheet will contain every matching product with its id  SKU and name for reference  plus the fields you selected.",
	"6" => "6",
	"translatable_fields" => "Translatable fields",
	"filter_products_to_include" => "Filter products to include",
	"search_by_name_or_SKU" => "Search by name or SKU",
	"products_updated_successfully" => "Products updated successfully",
	"purchase_Product" => "Purchase Product",
	"stock_History" => "Stock History",
	"search_or_filter_products_below,_enter_the_quantity_received_and_unit_cost_for_each_product,_then_submit_to_add_them_to_stock." => "Search or filter products below  enter the quantity received and unit cost for each product  then submit to add them to stock.",
	"use_the_filters_above_to_find_products_to_purchase." => "Use the filters above to find products to purchase.",
	"reference_no" => "Reference no",
	"quantity_received" => "Quantity received",
	"unit_cost" => "Unit cost",
	"submit_purchase" => "Submit purchase",
	"products_stock_updated_successfully" => "Products stock updated successfully",
	...
	"search_and_select_products_above_to_add_them_to_this_purchase." => "Search and select products above to add them to this purchase.",
	"new_purchase" => "New purchase",
	"search_by_reference_no" => "Search by reference no",
	"total_quantity" => "Total quantity",
	...
	"searching" => "Searching",
	"pos_sale_due" => "Pos sale due",
	"select_a_customer_to_place_a_due_or_partially_paid_order" => "Select a customer to place a due or partially paid order",
	"due_balance" => "Due balance",
	"record_payment" => "Record payment",
	"due_ledger" => "Due ledger",
	"balance_after" => "Balance after",
	"sale_due" => "Sale due",
	"record_due_payment" => "Record due payment",
	"current_due_balance" => "Current due balance",
	"due_payment_recorded" => "Due payment recorded",
