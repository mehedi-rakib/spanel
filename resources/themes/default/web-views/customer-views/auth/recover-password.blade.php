            ...
            <div class="col-lg-8 col-md-10 text-start">
                ...
                <ol class="list-unstyled font-size-md p-0">
                    <li>
                        ...
                        {{ translate('use_your_registered_mail.')}}
                    </li>
                    <li>
                        <span class="text-primary mr-2">{{ translate('2')}}.</span>
                        {{ translate('we_will_send_you_a_temporary_OTP_in_your_mail') }}.
                    </li>
                    <li>
                    ...
                    <form class="card-body needs-validation" action="{{route('customer.auth.forgot-password')}}"
                        ...
                        <div class="form-group">
                            <label for="recover-email">
                                {{ translate('Mail_Address') }}
                            </label>
                            <input class="form-control clean-phone-input-value" type="email" name="identity" required
                                   placeholder="{{ translate('enter_your_mail_address') }}">
                            <span class="fs-12 text-muted">* {{ translate('please_provide_valid_email') }}</span>
