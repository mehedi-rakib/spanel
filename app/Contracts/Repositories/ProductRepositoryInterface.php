...
{
    /**
     * Streams matching products one at a time instead of loading them all into memory.
     * @param array $filters supports: category_id, brand_id, status, searchValue, code
     * @param array $relations
     * @return LazyCollection
     */
    public function cursorWhere(array $filters = [], array $relations = []): LazyCollection;
